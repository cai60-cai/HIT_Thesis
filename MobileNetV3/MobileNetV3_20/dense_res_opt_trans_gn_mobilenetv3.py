...
class MobileBottleneck(nn.Module):
    ...
    def __init__(self, inp, oup, hidden_dim, kernel_size, stride, use_se, use_hs):
        ...
        self.conv3 = nn.Sequential(
            ...
            nn.GroupNorm(num_groups=4, num_channels=oup)
        )
...
class TrafficMobileNetV3(nn.Module):
    ...
    def __init__(self, num_classes=11):
        ...
        self.conv2 = nn.Sequential(
            ...
            nn.GroupNorm(num_groups=4, num_channels=160),
            HSwish()
        )
        ...
        # 引入Transformer模块
        self.transformer = nn.TransformerEncoder(nn.TransformerEncoderLayer(d_model=160, nhead=4), num_layers=2)
    ...
    def _initialize_weights(self):
        ...
        for m in self.modules():
            ...
            elif isinstance(m, (nn.GroupNorm, nn.Linear)):
