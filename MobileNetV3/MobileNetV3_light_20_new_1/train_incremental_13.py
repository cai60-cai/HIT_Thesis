...
#     save_dir = 'training_results_incremental_13_quanzhong3.0'
...
#     first_increment_val = IncrementalTrafficDataset(first_increment_dir, 'test', is_new_class=True, label_offset=11)
    
#     # 最新类别数据(13类)
#     new_train_dataset = IncrementalTrafficDataset(newest_data_dir, 'train', is_new_class=True, label_offset=12)
#     new_val_dataset = IncrementalTrafficDataset(newest_data_dir, 'test', is_new_class=True, label_offset=12)
    
#     # 合并数据集
#     train_dataset = ConcatDataset([old_train_dataset, first_increment_train, new_train_dataset])
#     val_dataset = ConcatDataset([old_val_dataset, first_increment_val, new_val_dataset])
...
#     class_weights[9] = 5.0  # PortScan的权重
...
def train_incremental_13():
    ...
    first_increment_dir = 'processed_data_incremental_last_5_3'  # 第一次增量数据
    newest_data_dir = 'processed_data_incremental_last_5_4'  # 最新类别数据
    save_dir = 'training_results_incremental_13_quanzhong5.0'
    old_model_path = 'training_results_incremental_yuohua_webmokuai/best_model.pth'  # 12类模型
