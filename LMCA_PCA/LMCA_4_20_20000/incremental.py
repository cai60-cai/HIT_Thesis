...
# 数据路径
input_file = "data/expanded_total_20000.csv"
output_file_1 = "data/incremental_data_1.csv"
output_file_2 = "data/train_1.csv"

# 读取数据
data = pd.read_csv(input_file)

# 指定需要分离出来的两类标签
incremental_labels = ["Web Attack � Brute Force", "Web Attack � Sql Injection","Web Attack � XSS","Bot"] 
